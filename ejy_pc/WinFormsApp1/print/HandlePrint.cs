...
namespace EnjoyPrint.print
{
    class HandlePrint
    {
        ...
        public static int HandlePrint2(TempFile file)
        {
            ...
            printDoc.DocumentName = file.file_name + "." + file.file_type;//打印框显示的文档名字
            ...
            printDoc.PrinterSettings.FromPage = file.print_from_page;
            Console.WriteLine(file.print_from_page);

            printDoc.PrinterSettings.ToPage = file.print_to_page;
            printDoc.DefaultPageSettings.Color = file.print_color == 2;//是否彩印
            ...
            {
                FormMain.formMain.UpdatePrintState(file.file_id, "正在打印...");
                ...
                FormMain.formMain.UpdatePrintState(file.file_id, "打印成功");
                return 1;
            }
            else
            {
                FormMain.formMain.UpdatePrintState(file.file_id, "打印失败");
                return 0;
            }
