(function () {
    ...
    var config = {
        ...
        qiniuBucketURLPrefix: 'https://image.pinghaifeng.cn',

        // 获取uptoken方法三选一即可，执行优先级为：uptoken > uptokenURL > uptokenFunc。三选一，剩下两个置空。推荐使用uptokenURL，详情请见 README.md
        // 由其他程序生成七牛云uptoken，然后直接写入uptoken
        qiniuUploadToken: 'MhA6pYcqsH5Ndp0Gkm9gE47TlHwSNjUhEWV0tFxl:VKSCSE9LSSpUJeh32PDxDApyjIs=:eyJzY29wZSI6InBpbmdoYWlmZW5nIiwiZGVhZGxpbmUiOjE5NTczNjE2MzR9',
